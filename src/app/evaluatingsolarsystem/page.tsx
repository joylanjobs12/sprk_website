                ...
                <div className="w-full max-w-7xl flex flex-col items-center justify-start">
                    <header className="w-full flex flex-col items-center justify-start gap-8 sm:gap-10 md:gap-12 lg:gap-16">
                        <div className="w-full flex flex-col items-center justify-start gap-6 sm:gap-7 md:gap-8 lg:gap-8">
                            {/* Main Heading */}
                            <h1 className="fade-up w-full text-center text-black font-medium font-['Aeonik_Pro'] leading-[110%] mb-4 sm:mb-3 md:mb-4 lg:mb-6 xl:mb-6 2xl:mb-6
        text-[40px] sm:text-[40px] md:text-[40px] lg:text-[80px] xl:text-[80px] 2xl:text-[80px] transition-all duration-300 ease-in-out">
                            ...
                            <div className="w-full flex items-center justify-center">
                                <p className="text-reveal text-center font-normal font-['Inter'] leading-[120%] text-[rgba(0,0,0,0.66)] mb-4 sm:mb-4 md:mb-4 lg:mb-4 xl:mb-4 2xl:mb-4 max-w-4xl
        text-[16px] sm:text-[16px] md:text-[16px] lg:text-[18px] xl:text-[18px] 2xl:text-[20px] transition-all duration-300 ease-in-out hover:text-[rgba(0,0,0,0.8)]">
            ...
            <section className="section-2 w-full flex flex-col items-center justify-start relative px-4 py-16 sm:px-6 sm:py-20 md:px-8 md:py-24 lg:px-24 lg:py-32 xl:py-36 2xl:py-40">
                <div className="w-full max-w-7xl flex flex-col items-start justify-start">
                    <div className="w-full flex flex-col lg:flex-row items-start justify-start gap-8 sm:gap-10 md:gap-12 lg:gap-16">
                        {/* Left Content */}
                        <div className="card-slide-left w-full lg:flex-1 flex flex-col items-start justify-start gap-6 sm:gap-7 md:gap-8 lg:gap-8">
                            {/* Section Heading */}
                            <div className="w-full flex items-start justify-start">
                                <h2 className="bounce-in text-black font-medium font-['Aeonik_Pro'] leading-[110%] mb-3 sm:mb-3 md:mb-4 lg:mb-5 xl:mb-5 2xl:mb-5
                 text-[35px] sm:text-[35px] md:text-[35px] lg:text-[56px] xl:text-[56px] 2xl:text-[56px] transition-all duration-300 ease-in-out hover:text-[#115056] cursor-default">
                            ...
                            <div className="w-full flex items-start justify-start pt-0 sm:pt-2 md:pt-3 lg:pt-4">
                                <div className="text-reveal w-full font-normal font-['Aeonik_Pro'] leading-[110%] text-[rgba(0,0,0,0.66)]
                 text-[18px] sm:text-[18px] md:text-[18px] lg:text-[25px] xl:text-[25px] 2xl:text-[25px] transition-all duration-300 ease-in-out">
                        ...
                        {/* Right Image */}
                        <div className="card-slide-right w-full lg:flex-1 flex flex-col items-center justify-center mt-8 lg:mt-0">
            ...
            <section className="section-3 w-full flex flex-col items-center justify-start relative px-4 py-16 sm:px-6 sm:py-20 md:px-8 md:py-24 lg:px-24 lg:py-32 xl:py-36 2xl:py-40">
                <div className="w-full max-w-7xl flex flex-col items-center justify-start gap-12 sm:gap-14 md:gap-16 lg:gap-20">
                    {/* Section Header */}
                    <div className="w-full flex flex-col items-center justify-start gap-6 sm:gap-7 md:gap-8 lg:gap-12">
                        <div className="w-full flex items-center justify-center">
                            <h2 className="bounce-in text-center text-black font-medium font-['Aeonik_Pro'] leading-[110%] mb-3 sm:mb-3 md:mb-4 lg:mb-5 xl:mb-5 2xl:mb-5
                             text-[35px] sm:text-[35px] md:text-[35px] lg:text-[56px] xl:text-[56px] 2xl:text-[56px] transition-all duration-300 ease-in-out hover:text-[#115056] cursor-default">
                        ...
                        <div className="w-full flex flex-col items-center justify-start gap-2">
                            <div className="w-full flex items-center justify-center">
                                <h4 className="text-reveal text-center text-black font-medium font-['Aeonik_Pro'] leading-[110%] mb-0
                                 text-[25px] sm:text-[25px] md:text-[25px] lg:text-[35px] xl:text-[35px] 2xl:text-[35px] transition-all duration-300 ease-in-out hover:text-[rgba(0,0,0,0.8)]">
                    ...
                    <div className="w-full flex flex-wrap items-center justify-center gap-6 lg:gap-6">
                            ...
                            <div className="w-full flex flex-col items-center justify-start">
                                ...
                                <div className="w-full bg-gray-50 flex flex-col items-center justify-start gap-5 px-0 py-[30px] pt-[50px] transition-colors duration-300 ease-in-out group-hover:bg-[#F8FFFE]">
                                    <div className="w-full flex items-start justify-start px-[30px]">
                                        <h3 className="text-black font-medium font-['Aeonik_Pro'] leading-[110%] mb-0 min-h-[70px] flex items-center
                                         text-[25px] sm:text-[25px] md:text-[25px] lg:text-[32px] xl:text-[32px] 2xl:text-[32px] transition-colors duration-300 ease-in-out group-hover:text-[#115056]">
                                            System Size & Capacity
                                        </h3>
                                    </div>
                                    <div className="w-full flex items-center justify-start px-[30px] py-2.5">
                                        <p className="text-[rgba(0,0,0,0.66)] font-medium font-['Inter'] leading-[110%] mb-0 min-h-11 flex items-center
                                         text-[16px] sm:text-[16px] md:text-[16px] lg:text-[20px] xl:text-[20px] 2xl:text-[20px] transition-colors duration-300 ease-in-out group-hover:text-[rgba(0,0,0,0.8)]">
                        ...
                        <div className="card-flip flex-1 min-w-[300px] max-w-[400px] bg-white rounded-[10px] border border-[rgba(17,80,86,0.5)] shadow-[0px_63px_25px_0px_rgba(38,142,151,0.02),0px_36px_21px_0px_rgba(38,142,151,0.08),0px_16px_16px_0px_rgba(38,142,151,0.13),0px_4px_9px_0px_rgba(38,142,151,0.1)] overflow-hidden transition-all duration-300 ease-in-out hover:shadow-lg hover:scale-105 hover:border-[#115056] cursor-pointer group">
                            <div className="w-full flex flex-col items-center justify-start">
                                {/* Icon Section */}
                                <div className="w-full flex items-center justify-start p-[30px] border-b border-[#a5dcdf]">
                                    <div className="flex items-center justify-start gap-[30px]">
                                        <div className="w-[130px] h-[130px] bg-white rounded-[10px] border border-[#115056] flex items-center justify-center">
                                            <img
                                ...
                                {/* Content Section */}
                                <div className="w-full bg-gray-50 flex flex-col items-center justify-start gap-5 px-0 py-[30px] pt-[50px]">
                                    <div className="w-full flex items-start justify-start px-[30px]">
                                        <h3 className="text-black font-medium font-['Aeonik_Pro'] leading-[110%] mb-0 min-h-[70px] flex items-center
                                    ...
                                    <div className="w-full flex items-center justify-start px-[30px] py-2.5">
                                        <p className="text-[rgba(0,0,0,0.66)] font-medium font-['Inter'] leading-[110%] mb-0 min-h-11 flex items-center
                                         text-[16px] sm:text-[16px] md:text-[16px] lg:text-[20px] xl:text-[20px] 2xl:text-[20px]">
            ...
            <section className="section-6 w-full flex flex-col items-center justify-start relative px-4 py-16 sm:px-6 sm:py-20 md:px-8 md:py-24 lg:px-24 lg:py-32 xl:py-36 2xl:py-40">
                <div className="w-full max-w-7xl flex flex-col items-center justify-start gap-12 sm:gap-14 md:gap-16 lg:gap-20">
                    {/* Section Header */}
                    <div className="w-full flex flex-col items-center justify-start gap-5">
                        <div className="w-full flex items-center justify-center">
                            <h2 className="bounce-in text-center text-black font-medium font-['Aeonik_Pro'] leading-[110%] mb-0
                             text-[35px] sm:text-[35px] md:text-[35px] lg:text-[56px] xl:text-[56px] 2xl:text-[56px] transition-all duration-300 ease-in-out hover:text-[#115056] cursor-default">
                                ...
                                <div className="w-full h-full bg-white flex flex-col items-center justify-start min-w-[295px]">
                                    ...
                                    <div className="w-full flex flex-col items-start justify-start gap-5 px-0 py-[30px]">
                                        <div className="w-full flex items-start justify-start min-h-[60px] px-[30px] py-0">
                                            <h4 className="text-black font-medium font-['Aeonik_Pro'] leading-[110%] mb-0 text-[20px] sm:text-[20px] md:text-[20px] lg:text-[27px] xl:text-[27px] 2xl:text-[27px] transition-colors duration-300 ease-in-out group-hover:text-[#115056]">Measure Utility Savings</h4>
                                        </div>
            ...
            <section className="section-7 w-full flex flex-col items-center justify-start relative px-4 py-16 sm:px-6 sm:py-20 md:px-8 md:py-24 lg:px-24 lg:py-32 xl:py-36 2xl:py-40">
                <div className="w-full max-w-7xl flex flex-col items-center justify-start gap-12 sm:gap-14 md:gap-16 lg:gap-20">
                    {/* Section Header */}
                    <div className="w-full flex flex-col lg:flex-row items-start justify-start gap-6 sm:gap-7 md:gap-8 lg:gap-8">
                        <div className="card-slide-left w-full lg:flex-1 flex items-start justify-center">
                            <h2 className="fade-up text-black font-medium font-['Aeonik_Pro'] leading-[110%] mb-0 text-[35px] sm:text-[35px] md:text-[35px] lg:text-[56px] xl:text-[56px] 2xl:text-[56px] transition-all duration-300 ease-in-out hover:text-[#115056] cursor-default">How to Showcase the Value of Solar to Home Buyers</h2>
                        </div>
                        <div className="card-slide-right w-full lg:flex-1 flex items-start justify-center pt-0 lg:pt-[15px]">
                            <div className="text-reveal text-[rgba(0,0,0,0.66)] font-normal font-['Aeonik_Pro'] leading-[110%] text-[18px] sm:text-[18px] md:text-[18px] lg:text-[25px] xl:text-[25px] 2xl:text-[25px] transition-all duration-300 ease-in-out">
                    ...
                    <div className="cta-button w-full flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8">
                        ...
                        <div className="w-full sm:w-auto bg-[#115056] rounded-[5px] p-[5px] transition-all duration-200 ease-in-out hover:bg-white hover:shadow-lg cursor-pointer group hover:scale-105">
                            <div className="w-full sm:w-[418px] flex items-center justify-center px-[15px] py-[5px]">
                                <p className="flex-1 text-white font-normal font-['Inter'] leading-[120%] text-center mb-0 text-[18px] lg:text-[22px] group-hover:text-[#115056] transition-colors duration-200">Get a Solar Listing Report</p>
                        ...
                        <div className="w-full sm:w-auto bg-white border border-[#115056] rounded-[5px] p-[5px] transition-all duration-200 ease-in-out hover:bg-[#115056] hover:shadow-lg cursor-pointer group hover:scale-105">
                            <div className="w-full sm:w-[418px] flex items-center justify-center px-[15px] py-[5px]">
                                <p className="flex-1 text-black font-normal font-['Inter'] leading-[120%] text-center mb-0 text-[18px] lg:text-[22px] group-hover:text-white transition-colors duration-200">See a Sample Listing Report</p>
                                <div className="w-[30px] h-[30px] flex items-center justify-center ml-2 transition-transform duration-200 group-hover:translate-x-1">
                                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none">
