...
export default function EbookPage() {
    return (
        <>
            ...
            <section className="bg-[rgba(0,0,0,0.5)] flex flex-col gap-20 items-center justify-start px-6 sm:px-12 md:px-16 lg:px-24 py-[100px] relative w-full">
                <div className="bg-gray-50 flex flex-col gap-[50px] items-center justify-start p-6 sm:p-8 lg:p-[50px] relative rounded-[10px] w-full max-w-[800px]">
                    <div className="flex flex-col gap-[30px] items-start justify-center relative w-full">
                        {/* Title */}
                        <div className="flex items-start justify-center px-0 py-2.5 relative w-full">
                            <h4 className="w-full text-center">
                                {/* Mobile & Small Tablets (0px-767px) */}
                                <span className="block lg:hidden text-[25px] leading-[120%] font-medium font-['Aeonik_Pro'] text-black">
                                    Enter Email to Download the Ebook
                                </span>
                                
                                {/* Large screens (992px and above) */}
                                <span className="hidden lg:block text-[35px] leading-[110%] font-medium font-['Aeonik_Pro'] text-black">
                                    Enter Email to Download the Ebook
                                </span>
                            </h4>
                        </div>
                        ...
                        <div className="flex flex-col gap-2.5 items-start justify-center relative w-full">
                            <div className="bg-[#f4f4f4] border border-[rgba(0,0,0,0.25)] flex items-center justify-between px-[15px] py-5 relative rounded-[10px] w-full">
                                <input 
                                    type="email" 
                                    placeholder="Email"
                                    className="bg-transparent flex-1 outline-none text-[18px] sm:text-[20px] lg:text-[22px] leading-[110%] font-normal font-['Aeonik_Pro'] text-black placeholder-[rgba(0,0,0,0.35)]"
                                />
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-5 items-center justify-start relative w-full">
                            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center justify-start relative w-full">
                                ...
                                <button className="border border-[rgba(0,0,0,0.2)] flex items-center justify-center p-[10px] relative rounded-[5px] w-full sm:flex-1 hover:bg-gray-100 transition-colors">
                                    <span className="text-[20px] sm:text-[22px] lg:text-[25px] leading-[110%] font-medium font-['Inter'] text-[rgba(0,0,0,0.66)] text-center">
                                        Cancel
                                    </span>
                                </button>
                                ...
                                <button className="bg-[#115056] flex items-center justify-center p-[10px] relative rounded-[5px] w-full sm:flex-1 hover:bg-[#0d3d42] transition-colors">
                                    <span className="text-[18px] sm:text-[20px] lg:text-[22px] leading-[120%] font-normal font-['Inter'] text-center text-white">
                                        Download Ebook
                                    </span>
                                </button>
                            </div>
